    ...
    var PostcodeNl_Api = {
        ...
        showFields: function (fields) {
            ...
            fields.each(function (fieldId) {
                if ($(fieldId) && $(fieldId).up(pcnl.parentElementType)) {
                    ...
                    // jQuery('#'+fieldId).closest('li').removeClass('pcnl-hidden-field')
                }

                //***********************************************//
                // ADD ACTIVE CLASS TO INPUT WRAPPER TO TRIGGER FLOATING LABEL
                // CUSTOM CHANGE MADE BY WOUTER JUNE-2019
                //***********************************************//
                if($(fieldId) && $(fieldId).value){
                    $(fieldId).up('div').addClassName('active');
                }
            });
        },
        ...
        removeValidationMessages: function (prefix) {
            ...
            if (advice) {
                ...
                $(prefix + 'postcode_housenumber').up('li').removeClassName('wrong');
            }
            ...
            if (advice) {
                ...
                $(prefix + 'postcode_input').up('li').removeClassName('wrong');
            }
            ...
            if ($(prefix + 'postcode_housenumber_addition')) {
                ...
                if (additionAdvice) {
                    ...
                    $(prefix + 'postcode_housenumber_addition').up('li').removeClassName('wrong');
                }
            }
        },
                ...
                new Ajax.Request(url,
                    {
                        ...
                        onComplete: function (transport) {
                            ...
                            //*********************************************************//
                            // TOGGLE THE ADDRESS FIELDS TO VISIBLE WITH EXTRA SHOW PARAM
                            // ONLY TOGGLE THE ADDRESS FIELDS WHEN A NEW ADDRESS WAS FOUND
                            // IF NOT FOUND -> JSON CONTAINS MESSAGE
                            // CUSTOM CHANGE MADE BY WOUTER JUNE-2019
                            //**********************************************************//
                            if(!json.message && (!json.houseNumberAdditions && !json.houseNumberAdditions.length || json.houseNumberAddition)) {
                                pcnlapi.toggleAddressFields(prefix, postcodeFieldId, countryFieldId, street1, street2, street3, street4, undefined, true);
                                // pcnlapi.toggleAddressFields('shipping:', postcodeFieldId, countryFieldId, street1, street2, street3, street4, undefined, true);
                            }
                        }
                    });
            }
        ...
        updatePostcodeLookup: function (data, housenumber_addition, housenumber_addition_select, prefix, postcodeFieldId, countryFieldId, street1, street2, street3, street4, event) {
            ...
            if (data.postcode !== undefined) {
                ...
                if (!hasAdvice) {
                    $(prefix + 'postcode_input').addClassName('validation-passed');
                ...
                $(prefix + target).up('li').addClassName('wrong');
                this.removeHousenumberAddition(prefix);
            }
            else {
            ...
            if ($(prefix + countryFieldId).getValue() == 'NL') {
                ...
                if (!$(prefix + 'postcode_input:wrapper')) {
                    if ($$('table.form-list').length > 0 && $(prefix + postcodeFieldId).parentNode.tagName == 'TD') {
                        ...
                        $(prefix + street1).up('li').insert({
                            before: '<li id="' + prefix + 'postcode_input:wrapper"><div class="two-fields input-postcode"><label for="' + prefix + 'postcode_input">' + PCNLAPI_CONFIG.translations.postcodeInputLabel + ' <span class="required">*</span></label><br>' +
                        ...
                        if (!$(prefix + 'postcode_input:info')) {
                            $(prefix + street1).up('li.fields').insert({
                                before:
                                    '<li id="' + prefix + 'postcode_input:info">' +
                                    '<div class="input-box">' +
                                    '<label class="pcnl-info-label">' + PCNLAPI_CONFIG.translations.infoLabel + '</label>' +
                        ...
                        if (!$(prefix + 'postcode_input:info')) {
                            $(prefix + street1).up('div.aw-onestepcheckout-general-form-field').insert({
                                before:
                        ...
                        $(prefix + street1).up('div.full').insert({
                            before: '<div id="' + prefix + 'postcode_input:wrapper" class="two_fields"><div class="input-postcode short"><label for="' + prefix + 'postcode_input" class="required">' + PCNLAPI_CONFIG.translations.postcodeInputLabel + '</label> <sup>*</sup><div class="data_area"><input type="text" title="' + PCNLAPI_CONFIG.translations.postcodeInputTitle + '" id="' + prefix + 'postcode_input" value="" class="t1 required-entry" /></div></div>' +
                        ...
                        //******************************************************************************************
                        // CUSTOM CHANGES FOR NEW ONEPAGE CHECKOUT => 13-06-2019
                        // The info text has been removed and the input fields are updated to match the design
                        ...
                        // 	$(prefix + street1).up('li').insert({before: '<li id="' + prefix + 'postcode_input:info" class="wide pcnl-info"><div><label class="pcnl-info-label">'+ PCNLAPI_CONFIG.translations.infoLabel +'</label><div class="pcnl-info-text" id="' + prefix + 'postcode_input:info-text">'+ PCNLAPI_CONFIG.translations.infoText +'</div></div></li>'});
                        // }
                        $(prefix + street1).up('li').insert({before: '<li id="' + prefix + 'postcode_input:wrapper" class="fields transition"><div><div class="field input-postcode"><label for="' + prefix + 'postcode_input">' + PCNLAPI_CONFIG.translations.postcodeInputLabel + '<span class="cartrequired">*</span></label><input data-placeholder="' + PCNLAPI_CONFIG.translations.postcodeInputLabel + '" type="text" tabindex="4" title="' + PCNLAPI_CONFIG.translations.postcodeInputTitle + '" id="' + prefix + 'postcode_input" value="" class="input-text required-entry" /></div><div class="field input-postcode pcnl-input-housenumber"><label for="' + prefix + 'postcode_housenumber">' + PCNLAPI_CONFIG.translations.houseNumberLabel + ' <span class="cartrequired">*</span></label><input data-placeholder="' + PCNLAPI_CONFIG.translations.houseNumberLabel + '" type="text" tabindex="5" title="' + PCNLAPI_CONFIG.translations.houseNumberTitle + '" name="' + prefix + 'postcode_housenumber" id="' + prefix + 'postcode_housenumber" value="" class="input-text pcnl-input-text-half required-entry" /></div></div></li>'});
                        if (!$(prefix + 'postcode_input:checkbox')) {
                            $(prefix + 'checkboxtarget').insert({after: '<li id="' + prefix + 'postcode_input:checkbox" class="wide control pcnl-manual-checkbox"><div class=""><input type="checkbox" title="' + PCNLAPI_CONFIG.translations.postcodeInputTitle + '" id="' + prefix + 'postcode_input_checkbox" value="" class="checkbox " /><label for="' + prefix + 'postcode_input_checkbox">' + PCNLAPI_CONFIG.translations.manualInputText + '</label></div></li>'});
                            $(prefix + 'postcode_input_checkbox').observe('click', function () {
                                pcnlapi.toggleCountryPostcode(prefix, postcodeFieldId, countryFieldId, street1, street2, street3, street4);
                            });
                        }
                        $(prefix + street1).up('li').insert({before: '<li id="' + prefix + 'postcode_input:output" class="wide pcnl-hidden-field foundaddress"><div><label>' + PCNLAPI_CONFIG.translations.outputLabel + '</label><div id="' + prefix + 'postcode_output" class="pcnl-address-text"></div></div></li>'});
                    }
                    ...
                    $(prefix + 'postcode_input').observe('change', function (e) {
                        pcnlapi.lookupPostcode(prefix, postcodeFieldId, countryFieldId, street1, street2, street3, street4, e);
                    });
                ...
                if ($(prefix + 'postcode_input_checkbox').disabled) {
                    ...
                    // CUSTOM CHANGES TO SHOW ADDRESSFIELDS AFTER FILLING IN YOUR POSTCODE ONCE
                    if($(prefix+'postcode_input').value && $(prefix+'postcode_housenumber').value){
                        this.toggleAddressFields(prefix, postcodeFieldId, countryFieldId, street1, street2, street3, street4, undefined, true);
                        // this.hideFields(['shipping:' + 'postcode_output', 'shipping:' + 'postcode_input', 'shipping:' + 'postcode_housenumber']);
                    }else{
                        this.toggleAddressFields(prefix, postcodeFieldId, countryFieldId, street1, street2, street3, street4);
                    }
         ...
         */
        toggleAddressFields: function (prefix, postcodeFieldId, countryFieldId, street1, street2, street3, street4, values, show) {
            // Should not happen, but may occur if things go half-awry
            if (!$(prefix + 'postcode_input_checkbox'))
                return;
            //*********************************************************//
            // ADDED SHOW TO TOGGLE THE ADDRESS FIELDS TO VISIBLE
            // ON THE ONCOMPLETE EVENT OF THE AJAX REQUEST
            // CUSTOM CHANGE MADE BY WOUTER JUNE-2019
            //**********************************************************//
            if (!$(prefix + 'postcode_input_checkbox').checked && !show) {
                this.setFieldsReadonly([
                    prefix + postcodeFieldId,
                    prefix + street1,
                    prefix + street2,
                ...
                //*********************************************************//
                // NO LONGER DISABLE THE INITIAL POSTCODE AND NUMBER FIELDS,
                // BUT ADD A CLASS TO TRIGGER A CSS TRANSITION
                // CUSTOM CHANGE MADE BY WOUTER JUNE-2019
                //**********************************************************//
                // Disable fields
                ...
                // this.setFieldsReadonly([prefix + 'postcode_input', prefix + 'postcode_housenumber', prefix + 'postcode_housenumber_addition'], true);
                if($(prefix+'postcode_input').value && $(prefix+'postcode_housenumber').value){
                    this.hideFields([prefix + 'postcode_output', prefix + 'postcode_input', prefix + 'postcode_housenumber', prefix+ 'postcode_input_checkbox']);
                }
            }
        },
        ...
        createPostcodeHouseNumberAddition: function (prefix, postcodeFieldId, countryFieldId, street1, street2, street3, street4, values, custom) {
            ...
            $(prefix + 'postcode_housenumber_addition').observe('change', function (e) {
                pcnlapi.lookupPostcode(prefix, postcodeFieldId, countryFieldId, street1, street2, street3, street4, e);
            });
        ...
        addAddressCheckObservers: function () {
            ...
            if ($('billing_postcode')) {
                if ($('billing_country_id')) {
                    $('billing_country_id').observe('change', function () {
                        pcnlapi.toggleCountryPostcode('billing_', 'postcode', 'country_id', 'street1', 'street2', 'street3', 'street4');
                    });
                ...
                if ($('shipping_country_id')) {
                    $('shipping_country_id').observe('change', function () {
                        pcnlapi.toggleCountryPostcode('shipping_', 'postcode', 'country_id', 'street1', 'street2', 'street3', 'street4');
                    });
            ...
            if ($('street_1') && ($('zip') || $('postcode'))) {
                ...
                $('country').observe('change', function () {
                    pcnlapi.toggleCountryPostcode('', postcodefield, 'country', 'street_1', 'street_2', 'street_3', 'street_4');
                });
            ...
            if ($('postcode') && $('street0')) {
                ...
                $('country_id').observe('change', function () {
                    pcnlapi.toggleCountryPostcode('', 'postcode', 'country_id', 'street0', 'street1', 'street2', 'street3');
                });
            ...
            if ($('address_form_container')) {
                ...
                $('address_form_container').observe('DOMNodeInserted', function (e) {
                    pcnlapi.observeAdminCustomerAddress();
                });
            }
            ...
            for (nr = 1; nr < 15; nr++) {
                if ($('_item' + nr + 'postcode') && !$('_item' + nr + 'postcode').observed) {
                    $('_item' + nr + 'postcode').observe('change', function (e) {
                        var localNr = nr;
                        return function () {
                            pcnlapi.lookupPostcode('_item' + localNr, 'postcode', 'country_id', 'street0', 'street1', 'street2', 'street3', e);
                        }
                    }());
                    ...
                    $('_item' + nr + 'country_id').observe('change', function (e) {
                        var localNr = nr;
                        return function () {
                            pcnlapi.toggleCountryPostcode('_item' + localNr, 'postcode', 'country_id', 'street0', 'street1', 'street2', 'street3');
                        }
                    }());
        ...
        observeAdminShippingAddress: function () {
            ...
            if (!$('order-shipping_same_as_billing').checked) {
                ...
                $('order-shipping_address_country_id').observe('change', function () {
