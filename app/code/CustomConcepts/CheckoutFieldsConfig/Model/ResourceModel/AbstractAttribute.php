...
abstract class AbstractAttribute extends \Magento\Eav\Model\ResourceModel\Entity\Attribute
{
    /**
     ...
     * @return \Magento\Eav\Model\ResourceModel\Attribute
     */
    ...
    protected function _getLoadSelect($field, $value, $object)
    {
        ...
        if ($websiteId) {
            ...
            if($storeId = $object->getData('store_id')){
                $conditionSql .= $connection->quoteInto(
                    ' AND scope_table.store_id = ?',
                    (int)$storeId
                );
            }
