<?php
namespace CustomConcepts\CheckoutFieldsConfig\Model\ResourceModel\Form\Attribute\Eav;


/**
 * Code from Magento\Customer\Model\ResourceModel\Form\Attribute\Collection tp be extended by CustomConcepts\CheckoutFieldsConfig\Model\ResourceModel\Form\Attribute\Customer\Collection
 * cannot extend parent because _beforeLoad() needs to call its parent function
 */
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    protected function _beforeLoad()
    {
        ...
        if ($this->_getEavWebsiteTable()) {
            ...
            $joinWebsiteExpression .= $connection->quoteInto(
//                ' AND (sa.store_id = ? OR sa.store_id = 0)',
                ' AND (sa.store_id = ?)',
