...
class Save extends \CustomConcepts\CheckoutFieldsConfig\Swissup\FieldManager\Controller\Adminhtml\Index\Save
{
    ...
    public function __construct(
        ...
        parent::__construct($context, $resultPageFactory, $registry, $eavEntityFactory, $customerAttributeFactory, $websiteFactory, $urlFactory, $resultJsonFactory, $eavModelConfig, $eavAttributeSetFactory, $helper, $storeManager);
    }
}
