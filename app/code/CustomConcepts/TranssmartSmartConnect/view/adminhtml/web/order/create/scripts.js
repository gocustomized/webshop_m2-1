...
define([
...
], function (jQuery, confirm, alert, template, shippingTemplate, paymentTemplate, locationModal) {
    ...
    AdminOrder.prototype = {
        ...
        initialize: function (data) {
            // this.selectedLocationData.subscribe(function(data) {
            //     // todo check why it doesn't work for submit pickup location address
            //     alert({
            //         content: data.carrier_title
            //     });
            // });
            if (!data) data = {};
