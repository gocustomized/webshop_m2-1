...
namespace CustomConcepts\Checkout\Model\ValidationRules;
...
class AllowedCountryValidationRule implements QuoteValidationRuleInterface
{
    ...
    public function validate(Quote $quote): array
    {
        ...
        if (!$quote->isVirtual()) {
            ...
            $validationResult = in_array($shippingAddress->getCountryId(), $this->allowedCountryReader->getAllowedCountries());
