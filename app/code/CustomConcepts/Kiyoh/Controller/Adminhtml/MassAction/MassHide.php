...
class MassHide extends \CustomConcepts\Kiyoh\Controller\Adminhtml\AbstractAction {
    ...
    public function execute() {
        ...
        if (!is_array($reviewIds)) {
            ...
            try {
                ...
                $this->messageManager->addSuccess(__(sprintf('Total of %d review(s) were disabled.', count($reviewIds))));
            } catch (Exception $e) {
