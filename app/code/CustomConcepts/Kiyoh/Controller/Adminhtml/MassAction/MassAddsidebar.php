...
class MassAddsidebar extends \CustomConcepts\Kiyoh\Controller\Adminhtml\AbstractAction {
    ...
    public function execute() {
        ...
        if (!is_array($reviewIds)) {
            ...
            try {
                ...
                $this->messageManager->addSuccess(__(sprintf('Total of %d review(s) were added to the sidebar.', count($reviewIds))));
            } catch (Exception $e) {
